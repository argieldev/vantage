...
function Sidebar() {
  ...
  return (
    <aside className="fixed w-64 h-full border-r border-gray-300">
      ...
      <ul
        className={`flex flex-col p-2 gap-2 ml-4 ${displayClasses ? "block" : "hidden"}`}
      >
        <li className="flex items-center p-1 gap-2 text-sm rounded-md cursor-pointer">
          Data Structures
        </li>
        <li className="flex items-center p-1 gap-2 text-sm rounded-md cursor-pointer">OOP</li>
      </ul>
    </aside>
  );
}
